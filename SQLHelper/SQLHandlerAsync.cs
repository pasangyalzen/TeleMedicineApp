...
namespace SQLHelper
{
    public partial class SQLHandlerAsync
    {
        ...
        public int ExecuteNonQuery(SqlTransaction transaction, CommandType commandType, string commandText, IList<KeyValue> ParaMeterCollection, string outParamName)
        {
            //create a command and prepare it for execution
            SqlCommand cmd = new SqlCommand();
            PrepareCommand(cmd, transaction.Connection, transaction, commandType, commandText);
            int paramCount = ParaMeterCollection.Count;
        ...
        public void ExecuteNonQuery(SqlTransaction transaction, CommandType commandType, string commandText, IList<KeyValue> ParaMeterCollection)
        {
            //create a command and prepare it for execution
            SqlCommand cmd = new SqlCommand();
            PrepareCommand(cmd, transaction.Connection, transaction, commandType, commandText);
        ...
        public async Task<bool> ExecuteNonQueryAsBoolAsync(string StroredProcedureName, IList<KeyValue> ParaMeterCollection, string OutPutParamerterName)
        {
        ...
        /// <returns>Bool</returns>
        public async Task<bool> ExecuteNonQueryAsBoolAsync(string StroredProcedureName, IList<KeyValue> ParaMeterCollection, string OutPutParamerterName, object OutPutParamerterValue)
        {
            using (SqlConnection SQLConn = new SqlConnection(this._connectionString))
            {
        ...
        public async Task<int> ExecuteNonQueryAsync(string StroredProcedureName, IList<KeyValue> ParaMeterCollection)
        {
            using (SqlConnection SQLConn = new SqlConnection(this._connectionString))
            {
        ...
        /// <returns></returns>
        public async Task<T> ExecuteNonQueryAsGivenTypeAsync<T>(string StroredProcedureName, IList<KeyValue> ParaMeterCollection, string OutPutParamerterName)
        {
            using (SqlConnection SQLConn = new SqlConnection(this._connectionString))
            {
                SqlCommand SQLCmd = new SqlCommand();
        ...
        /// <param name="OutPutParamerterName">Accept Output parameter for the stored procedures</param>
        /// <returns></returns>
        public async Task<T> ExecuteNonQueryAsGivenTypeAsync<T>(string StroredProcedureName, IList<KeyValue> ParaMeterCollection, string OutPutParamerterName, object OutPutParamerterValue)
        {
            using (SqlConnection SQLConn = new SqlConnection(this._connectionString))
            {
                SqlCommand SQLCmd = new SqlCommand();
        ...
        /// <returns></returns>
        public async Task<int> ExecuteNonQueryAsync(string StroredProcedureName, IList<KeyValue> ParaMeterCollection, string OutPutParamerterName)
        {
            using (SqlConnection SQLConn = new SqlConnection(this._connectionString))
            {
        ...
        /// <param name="ParaMeterCollection">Accept Key Value Collection For Parameters</param>
        /// <returns></returns>
        public async Task<DataSet> ExecuteAsDataSetAsync(string StroredProcedureName, IList<KeyValue> ParaMeterCollection)
        {
            using (SqlConnection SQLConn = new SqlConnection(this._connectionString))
            {
                using (SqlCommand SQLCmd = new SqlCommand())
        ...
        /// <param name="ParaMeterCollection">Accept Key Value Collection For Parameters</param>
        /// <returns></returns>
        public async Task<SqlDataReader> ExecuteAsDataReaderAsync(string StroredProcedureName, IList<KeyValue> ParaMeterCollection)
        {
            using (SqlConnection SQLConn = new SqlConnection(this._connectionString))
            {
                using (SqlCommand SQLCmd = new SqlCommand())
        ...
        /// <param name="ParaMeterCollection">Accept Key Value Collection For Parameters</param>
        /// <returns></returns>
        public async Task<T> ExecuteAsObjectAsync<T>(string StroredProcedureName, IList<KeyValue> ParaMeterCollection)
        {
            using (SqlConnection SQLConn = new SqlConnection(this._connectionString))
            {
                using (SqlCommand SQLCmd = new SqlCommand())
        ...
        /// <returns></returns>
        public async Task<List<T>> ExecuteAsListAsync<T>(string StroredProcedureName, IList<KeyValue> ParaMeterCollection)
        {
            using (SqlConnection SQLConn = new SqlConnection(this._connectionString))
            {
                using (SqlCommand SQLCmd = new SqlCommand())
        ...
        /// <param name="ParaMeterCollection">Accept Key Value Collection For Parameters</param>
        /// <returns></returns>
        public async Task<T> ExecuteAsScalarAsync<T>(string StroredProcedureName, IList<KeyValue> ParaMeterCollection)
        {
            using (SqlConnection SQLConn = new SqlConnection(this._connectionString))
            {
                using (SqlCommand SQLCmd = new SqlCommand())
                {
                    ...
                    for (int i = 0; i < paramCount; i++)
                    {
                        ...
                        sqlParaMeter.IsNullable = true;
                        sqlParaMeter.ParameterName = ParaMeterCollection[i].Key;
                        sqlParaMeter.Value = ParaMeterCollection[i].Value ?? DBNull.Value;
                        SQLCmd.Parameters.Add(sqlParaMeter);
                    }
                    ...
                    try
                    {
                        ...
                        // Use default value if ExecuteScalarAsync returns null
                    ...
                    catch (Exception e)
                    {
                        ...
                        Console.WriteLine($"Error in ExecuteAsScalarAsync: {e.Message}");
                        throw;
                    }
                    finally
                    {
